...
# =============================== PER-FORK CONFIG ===============================
# Fleet tag: bagA
BASE_SEED = 0            # BagMLP derives member seeds = BASE_SEED*100 + i + 1
HIDDEN_SIZES = (512, 256, 128)      # MLP hidden-layer widths (per member)
...
def main():
    print(
        "[config] fleet=bagA arch=%s dropout=%s base_seed=%d n_members=%d"
